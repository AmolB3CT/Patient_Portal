...
//       this.Doctors_temp = data.data
//       this.Doctors.forEach(item=>{
//         if(!item.hasOwnProperty('profile_pic')){
//             item.profile_pic="assets/Images/user.png"
//         }
//       })
//     })
...
//     // console.log("username",this.selected_Doctor.username)
...
//           // this.Appointed_doctor.currentMedications=[...this.userDetail.currentMedications]
//           // this.Appointed_doctor.allergies=[...this.userDetail.allergies]
//           // this.Appointed_doctor.immunization=[...this.userDetail.immunization]
...
//           // this.Appointed_doctor.doc_id = this.selected_Doctor.id;
//           // this.Appointed_doctor.Date_time = this.date10; 
//           // this.Appointed_doctor.patient_name = this.userDetail.username,
//           // this.Appointed_doctor.patient_id = this.userDetail.id;
//           let dataPhy= {
//             physicianName:'',
//             dateAndTime:'',
//             type:''
